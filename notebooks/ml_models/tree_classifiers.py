...
def lgbm_classifier(train_set: List[pd.DataFrame],
    ...
    # assume multiclasse se objetivo nao for passado
    hyper_params = hyper_params if "objective" in hyper_params else assoc(hyper_params, 'objective', 'multiclass')
...
def xgb_classifier(train_set: List[pd.DataFrame],
    ...
    # check mandatory hyper params, assume multiclass
    hyper_params = hyper_params if "objective" in hyper_params else assoc(hyper_params, 'objective', 'multi:softmax')
